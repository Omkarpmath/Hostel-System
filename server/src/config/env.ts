...
export const env = {
  ...
  JWT_ACCESS_SECRET:
    process.env.JWT_ACCESS_SECRET || "bmsce_hostel_default_access_jwt_secret_token_2026",
  JWT_REFRESH_SECRET:
    process.env.JWT_REFRESH_SECRET || "bmsce_hostel_default_refresh_jwt_secret_token_2026",
