...
export class OperationsService {
    ...
    async decideLeave(id, approverId, data) {
    ...
    async createVisitor(userId, data) { return prisma.visitor.create({ data: { studentId: await this.studentId(userId), ...data }, include: studentInclude }); }
