...
export const leaveStatusSchema = z.object({ body: z.object({ status: z.enum(["APPROVED", "REJECTED"]), rejectionReason: z.string().min(3).optional() }).superRefine((d, ctx) => { if (d.status === "REJECTED" && !d.rejectionReason)
