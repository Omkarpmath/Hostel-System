...
import { allocationSchema, complaintStatusSchema, leaveSchema, leaveStatusSchema, visitorSchema, offlinePaymentSchema } from "./operations.schema.js";
const router = Router();
...
router.patch("/leaves/:id", authorize("ADMIN", "WARDEN"), validate(leaveStatusSchema), c.decideLeave.bind(c));
...
router.patch("/complaints/:id", authorize("ADMIN", "WARDEN"), validate(complaintStatusSchema), c.updateComplaint.bind(c));
