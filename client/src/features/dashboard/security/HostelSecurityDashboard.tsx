...
interface HostelSecurityDashboardProps {
  securityUser: any;
}

export const HostelSecurityDashboard: React.FC<HostelSecurityDashboardProps> = ({ securityUser }) => {
            ...
            {isSessionActive
              ...
              : isSessionCompleted
                ...
                : assignedHostelName
                  ...
                  : 'Please contact the administrator to assign your security account to a hostel block.'}
          </p>
        </div>
